...
seajs.config({base:"http://assets.diandong.com/mobile/"}),seajs.config({alias:{store:"js/util/store/1.3.17/store",swiper:"js/util/swiper/2.7.5/swiper",cookie:"js/util/cookie/cookie"}}),seajs.config({alias:{header:"components/header_v2/header-cf9cc2d925",header_v3:"components/header_v3/header",footer:"components/footer_v2/footer-51ff357080",return_top:"components/return_top/return_top-6b56321ed4",page:"components/page/page-fe7d15872a",area:"components/area/area-911143580f",user:"components/user/user-0a365d7788",mask:"components/mask/mask-1eef63b114",dialog:"components/dialog/dialog-bcc98bf40f",tip:"components/tip/tip-656c57cc89",location:"components/location/location-c6a620f60c",countdown:"components/countdown/countdown-433e957184",countdown_v2:"components/countdown_v2/countdown",quickselect:"components/quickselect/quickselect-df0cd07ffd",model_menu:"components/model_menu/model_menu",saleremind:"components/saleremind/saleremind-0534db0963",carselect:"components/carselect/carselect-0a59031ea6",cityselect:"components/cityselect/cityselect-4f9fb5521f",testdrive:"components/testdrive/testdrive-877a830476",ajaxform:"components/ajaxform/ajaxform",comment:"components/comment/comment-940699bfba",wxshare:"components/wxshare/wxshare",pagination:"components/pagination/pagination-265758f235",imglazyload:"components/imglazyload/imglazyload",finalprice:"components/finalprice/finalprice",postlist:"components/postlist/postlist",preorder:"components/preorder/preorder",freehotline:"components/freehotline/freehotline",appbar:"components/app_bar/app_bar"}}),function(e){function t(){var t=i.getBoundingClientRect().width;t/o>540&&(t=540*o),e.rem=t/16,i.style.fontSize=e.rem+"px"}var o,n,a,s=window.document,i=s.documentElement,c=s.querySelector('meta[name="viewport"]');if(c){var r=c.getAttribute("content").match(/initial\-scale=(["']?)([\d\.]+)\1?/);r&&(n=parseFloat(r[2]),o=parseInt(1/n))}else c=s.createElement("meta"),c.setAttribute("name","viewport"),c.setAttribute("content","width=device-width, initial-scale=1, user-scalable=no, minimal-ui"),i.firstElementChild.appendChild(c);e.addEventListener("resize",function(){clearTimeout(a),a=setTimeout(t,300)},!1),e.addEventListener("pageshow",function(e){e.persisted&&(clearTimeout(a),a=setTimeout(t,300))},!1),"complete"===s.readyState?s.body.style.fontSize=12*o+"px":s.addEventListener("DOMContentLoaded",function(){s.body.style.fontSize=12*o+"px"},!1),t()}(window);